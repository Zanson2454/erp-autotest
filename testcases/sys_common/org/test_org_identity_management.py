...
class TestOrgIdentityManagement(SysCommonBaseTest):
    """组织身份管理测试类"""
    ...
    @case_decorator(
        story="组织身份管理",
        title="测试创建组织身份",
        description="验证ORG_IDENTITY_CF_CREATE_DATA_SERVICE功能",
        severity="blocker",
        order=1,
        smoke=True,
        tags=["sys_common", "org_identity", "创建"]
    )
    def test_create_identity(self):
        ...
        try:
            ...
            self.logger.info(f"创建组织身份成功: ID={self.identity_id}")
    ...
    @case_decorator(
        story="组织身份管理",
        title="测试保存组织身份",
        description="验证ORG_IDENTITY_CF_SAVE_DATA_SERVICE功能",
        severity="critical",
        order=2,
        tags=["sys_common", "org_identity", "创建"]
    )
    ...
    @case_decorator(
        story="组织身份管理",
        title="测试批量创建组织身份",
        description="验证ORG_IDENTITY_CF_BATCH_CREATE_DATA_SERVICE功能",
        severity="normal",
        order=3,
        tags=["sys_common", "org_identity", "创建"]
    )
    def test_batch_create_identity(self):
        """批量创建组织身份数据"""
        try:
            identity_list = []
            for i in range(3):
            ...
            api_path = self.get_api_path("组织身份表-批量创建数据服务")
            params, url = self.get_api_params(api_path)
            ...
            a.json(filtered_params, "请求数据")
            a.json(response, "响应数据")
            self.logger.info(f"批量创建组织身份成功: 共{len(identity_list)}条")
    ...
    @case_decorator(
        story="组织身份管理",
        title="测试保存主数据",
        description="验证ORG_IDENTITY_CF_MASTER_DATA_SAVE_DATA_SERVICE功能",
        severity="critical",
        order=4,
        tags=["sys_common", "org_identity", "创建"]
    )
    ...
    @case_decorator(
        story="组织身份管理",
        title="测试分页查询",
        description="验证ORG_IDENTITY_CF_PAGING_DATA_SERVICE功能",
        severity="blocker",
        order=5,
        smoke=True,
        tags=["sys_common", "org_identity", "查询"]
    )
    def test_paging_query(self):
        """分页查询组织身份"""
        try:
            api_path = self.get_api_path("组织身份表-分页数据服务")
            params, url = self.get_api_params(api_path)
    ...
    @case_decorator(
        story="组织身份管理",
        title="测试查找单条数据",
        description="验证ORG_IDENTITY_CF_FIND_ONE_DATA_SERVICE功能",
        severity="critical",
        order=6,
        tags=["sys_common", "org_identity", "查询"]
    )
    ...
    @case_decorator(
        story="组织身份管理",
        title="测试查找列表数据",
        description="验证ORG_IDENTITY_CF_FIND_LIST_DATA_SERVICE功能",
        severity="critical",
        order=7,
        tags=["sys_common", "org_identity", "查询"]
    )
    ...
    @case_decorator(
        story="组织身份管理",
        title="测试根据ID查找数据",
        description="验证ORG_IDENTITY_CF_FIND_DATA_BY_ID_SERVICE功能",
        severity="blocker",
        order=8,
        smoke=True,
        tags=["sys_common", "org_identity", "查询"]
    ...
    def test_find_data_by_id(self):
        ...
        try:
            ...
            a.json(filtered_params, "请求数据")
            a.json(response, "响应数据")
            self.logger.info(f"根据ID查找组织身份数据成功: ID={self.identity_id}")
    ...
    @case_decorator(
        story="组织身份管理",
        title="测试根据ID查找单表数据",
        description="验证ORG_IDENTITY_CF_FIND_SINGLE_DATA_BY_ID_SERVICE功能",
        severity="critical",
        order=9,
        tags=["sys_common", "org_identity", "查询"]
    )
    def test_find_single_data_by_id(self):
        ...
        try:
            ...
            a.json(filtered_params, "请求数据")
            a.json(response, "响应数据")
            self.logger.info(f"根据ID查找单表数据成功: ID={self.identity_id}")
    ...
    @case_decorator(
        story="组织身份管理",
        title="测试根据ID列表查找数据",
        description="验证ORG_IDENTITY_CF_FIND_DATA_BY_IDS_SERVICE功能",
        severity="normal",
        order=10,
        tags=["sys_common", "org_identity", "查询"]
    )
    def test_find_data_by_ids(self):
        ...
        try:
            ...
            a.json(filtered_params, "请求数据")
            a.json(response, "响应数据")
            self.logger.info("根据ID列表查找组织身份数据成功")
    ...
    @case_decorator(
        story="组织身份管理",
        title="测试根据ID更新数据",
        description="验证ORG_IDENTITY_CF_UPDATE_DATA_BY_ID_SERVICE功能",
        severity="blocker",
        order=11,
        smoke=True,
        tags=["sys_common", "org_identity", "更新"]
    )
    def test_update_data_by_id(self):
        ...
        try:
            ...
            api_path = self.get_api_path("组织身份表-根据ID更新数据服务")
            params, url = self.get_api_params(api_path)
            ...
            a.json(filtered_params, "请求数据")
            a.json(response, "响应数据")
            self.logger.info(f"更新组织身份成功: ID={self.identity_id}")
    ...
    @case_decorator(
        story="组织身份管理",
        title="测试启用主数据",
        description="验证ORG_IDENTITY_CF_MASTER_DATA_ENABLE_DATA_SERVICE功能",
        severity="critical",
        order=12,
        tags=["sys_common", "org_identity", "启用禁用"]
    )
    def test_enable_data(self):
        ...
        try:
            ...
            a.json(filtered_params, "请求数据")
            a.json(response, "响应数据")
            self.logger.info(f"启用组织身份成功: ID={self.identity_id}")
    ...
    @case_decorator(
        story="组织身份管理",
        title="测试禁用主数据",
        description="验证ORG_IDENTITY_CF_MASTER_DATA_DISABLE_DATA_SERVICE功能",
        severity="critical",
        order=13,
        tags=["sys_common", "org_identity", "启用禁用"]
    )
    def test_disable_data(self):
        ...
        try:
            ...
            a.json(filtered_params, "请求数据")
            a.json(response, "响应数据")
            self.logger.info(f"禁用组织身份成功: ID={self.identity_id}")
    ...
    @case_decorator(
        story="组织身份管理",
        title="测试批量启用主数据",
        description="验证ORG_IDENTITY_CF_MASTER_DATA_MULTI_ENABLE_DATA_SERVICE功能",
        severity="normal",
        order=14,
        tags=["sys_common", "org_identity", "启用禁用"]
    )
    ...
    @case_decorator(
        story="组织身份管理",
        title="测试批量禁用主数据",
        description="验证ORG_IDENTITY_CF_MASTER_DATA_MULTI_DISABLE_DATA_SERVICE功能",
        severity="normal",
        order=15,
        tags=["sys_common", "org_identity", "启用禁用"]
    )
    ...
    @case_decorator(
        story="组织身份管理",
        title="测试折叠关联关系",
        description="验证ORG_IDENTITY_CF_FOLDING_ASSOCIATED_SERVICE功能",
        severity="normal",
        order=16,
        tags=["sys_common", "org_identity", "其他"]
    )
    ...
    @case_decorator(
        story="组织身份管理",
        title="测试标准导入",
        description="验证ORG_IDENTITY_CF_GEI_IMPORT_SERVICE功能",
        severity="normal",
        order=17,
        tags=["sys_common", "org_identity", "导入"]
    )
    ...
    @case_decorator(
        story="组织身份管理",
        title="测试标准导出",
        description="验证ORG_IDENTITY_CF_GEI_EXPORT_SERVICE功能",
        severity="normal",
        order=18,
        tags=["sys_common", "org_identity", "导出"]
    )
    ...
    @case_decorator(
        story="组织身份管理",
        title="测试通过OSS提交导入任务",
        description="验证ORG_IDENTITY_CF_API_GEI_TASK_IMPORT_DIRECT_BY_OSS_POST功能",
        severity="normal",
        order=19,
        tags=["sys_common", "org_identity", "导入"]
    )
    ...
    @case_decorator(
        story="组织身份管理",
        title="测试提交导出任务",
        description="验证ORG_IDENTITY_CF_API_GEI_TASK_EXPORT_DIRECT_POST功能",
        severity="normal",
        order=20,
        tags=["sys_common", "org_identity", "导出"]
    )
    ...
    @case_decorator(
        story="组织身份管理",
        title="测试根据ID删除数据",
        description="验证ORG_IDENTITY_CF_DELETE_DATA_BY_ID_SERVICE功能",
        severity="critical",
        order=21,
        tags=["sys_common", "org_identity", "删除"]
    )
    def test_delete_data_by_id(self):
        ...
        try:
            ...
            a.json(filtered_params, "请求数据")
            a.json(response, "响应数据")
            self.logger.info(f"删除组织身份成功: ID={self.identity_id}")
            
            self.__class__.identity_id = None
    ...
    @case_decorator(
        story="组织身份管理",
        title="测试批量删除数据",
        description="验证ORG_IDENTITY_CF_BATCH_DELETE_DATA_SERVICE功能",
        severity="normal",
        order=22,
        tags=["sys_common", "org_identity", "删除"]
    )
    def test_batch_delete_data(self):
        ...
        try:
            ...
            # 批量删除
            api_path = self.get_api_path("组织身份表-批量删除数据服务")
            params, url = self.get_api_params(api_path)
