...
class TestOrgDimensionManagement(SysCommonBaseTest):
    ...
    @case_decorator(
        story="组织维度管理",
        title="测试标准导入",
        description="验证ORG_DIMENSION_CF_GEI_IMPORT_SERVICE功能",
        severity="normal",
        order=16,
        tags=["sys_common", "org_dimension", "导入"]
    )
    ...
    @case_decorator(
        story="组织维度管理",
        title="测试标准导出",
        description="验证ORG_DIMENSION_CF_GEI_EXPORT_SERVICE功能",
        severity="normal",
        order=17,
    ...
    @case_decorator(
        story="组织维度管理",
        title="测试通过OSS提交导入任务",
        description="验证ORG_DIMENSION_CF_API_GEI_TASK_IMPORT_DIRECT_BY_OSS_POST功能",
        severity="normal",
        order=18,
        tags=["sys_common", "org_dimension", "导入"]
    )
