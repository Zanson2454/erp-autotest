...
class TestUomManagement(GenMdBaseTest):
    """计量单位管理测试类"""
    ...
    def test_save_uom(self):
        ...
        try:
            ...
            uom_name = f"计量单位管理_{self.mock_data.get_timestamp()}"
            ...
            uom_id = response.get("data", {}).get("data", {})
