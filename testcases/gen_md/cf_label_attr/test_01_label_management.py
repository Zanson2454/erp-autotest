...
class TestLabelManagement(GenMdBaseTest):
    ...
    def test_save_label(self):
        ...
        try:
            ...
            label_name = f"标签管理_{self.mock_data.get_timestamp()}"
            ...
            label_id = response.get("data", {}).get("data", {})
