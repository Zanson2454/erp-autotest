...
class TestAttrManagement(GenMdBaseTest):
    ...
    def test_save_attr(self):
        ...
        try:
            ...
            attr_name = f"属性管理_{self.mock_data.get_timestamp()}"
            ...
            attr_id = response.get("data", {}).get("data", {})
