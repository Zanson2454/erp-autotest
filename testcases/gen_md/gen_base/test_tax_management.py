...
class TestTaxManagement(GenMdBaseTest):
    ...
    def test_save_tax(self):
        ...
        try:
            ...
            tax_name = f"税配置管理_{self.mock_data.get_timestamp()}"
            ...
            tax_id = response.get("data", {}).get("data", {})
