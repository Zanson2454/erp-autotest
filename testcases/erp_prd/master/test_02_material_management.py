...
from testcases.erp_prd.master import MaterialType, PrdMasterBaseTest
            ...
            with a.step("1. 为所有物料创建生产视图"):
                for material in self.test_materials:
                    ...
                    filtered_params = ParamUtil.filter_post_body_fields(
                        params, list(create_data.keys()), ["params", "request"]
                    )
...
if __name__ == "__main__":
    ...
    test.setup_class()
    test.test_create_material_view()  # 创建物料生产视图
